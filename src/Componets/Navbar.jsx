...
const Navbar = () => {
  return (
    <Fragment>
      <div className="z-[3] absolute left-0 right-0 top-0 border-b border-gray-300">
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              ...
              >
                <img
                  ...
                  alt="Flowbite Logo"
                />
                <span class="self-center text-4xl font-semibold whitespace-nowrap dark:text-white font-poppin">
                  SMT
                </span>
              </a>
